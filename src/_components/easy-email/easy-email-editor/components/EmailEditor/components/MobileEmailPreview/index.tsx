...
import iphoneFrame from '@/_components/easy-email/easy-email-editor/assets/images/iphone.png';
...
import { SyncScrollIframeComponent } from '@/_components/easy-email/easy-email-editor/components/UI/SyncScrollIframeComponent';
