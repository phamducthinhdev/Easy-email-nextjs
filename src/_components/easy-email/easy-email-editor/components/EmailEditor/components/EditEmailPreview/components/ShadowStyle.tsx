...
import iconfontText from '@/_components/easy-email/easy-email-editor/assets/font/iconfont.css?inline';
import styles from '@/_components/easy-email/easy-email-editor/styles/block-shadowDom-interactive.css?inline';
