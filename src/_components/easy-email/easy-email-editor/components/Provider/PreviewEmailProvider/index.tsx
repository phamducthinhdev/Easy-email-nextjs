...
import { useLazyState } from '@/_components/easy-email/easy-email-editor/hooks/useLazyState';
import { HtmlStringToPreviewReactNodes } from '@/_components/easy-email/easy-email-editor/utils/HtmlStringToPreviewReactNodes';
...
export const PreviewEmailProvider: React.FC<{ children?: React.ReactNode }> = props => {
  ...
  useEffect(() => {
    ...
    return () => {
      // Check if the iframe is still a child of the body before removing
