import { useFocusIdx } from '@/_components/easy-email/easy-email-editor/hooks/useFocusIdx';
import React, { useEffect, useMemo, useState } from 'react';
import { getBlockNodeByIdx, getShadowRoot } from '@/_components/easy-email/easy-email-editor/utils';
import { DATA_RENDER_COUNT } from '@/_components/easy-email/easy-email-editor/constants';
import { useEditorContext } from '@/_components/easy-email/easy-email-editor/hooks/useEditorContext';
import { useRefState } from '@/_components/easy-email/easy-email-editor/hooks/useRefState';
